...
- **Variable:** A named container used to store data values (e.g., `let score = 10;`).
- **console.log():** A command used to print messages to the web browser's developer console for debugging.
