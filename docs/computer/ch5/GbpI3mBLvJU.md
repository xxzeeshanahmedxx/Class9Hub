...
- **Event Listener:** Code that waits for a user action (like an `onclick` event on a button) to trigger a function.

## Key Points and Lists from the Lecture
- **Syntax:** `function sayHello() { console.log("Hello!"); }`
- Functions save time and keep the code clean and organized.
